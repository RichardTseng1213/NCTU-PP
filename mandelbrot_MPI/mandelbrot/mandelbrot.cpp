...
int main(int argc, char *argv[])
{
	...
	while( i32InitCnt<i32TotalRankCnt )
	{
		...
		MPI_Irecv(&r[i32OffsetBack][0] , i32ElePerBlock , MPI_INT , i32Prev , 0 ,MPI_COMM_WORLD, &Request[0] );
		MPI_Isend(&r[i32StFor][0] , i32ElePerBlock , MPI_INT , i32Next , 0 ,MPI_COMM_WORLD, &Request[1] );	

		MPI_Irecv(&g[i32OffsetBack][0] , i32ElePerBlock , MPI_INT , i32Prev , 0 ,MPI_COMM_WORLD, &Request[2] );
		MPI_Isend(&g[i32StFor][0] , i32ElePerBlock , MPI_INT , i32Next , 0 ,MPI_COMM_WORLD, &Request[3] );	

		MPI_Irecv(&b[i32OffsetBack][0] , i32ElePerBlock , MPI_INT , i32Prev , 0 ,MPI_COMM_WORLD, &Request[4] );
		MPI_Isend(&b[i32StFor][0] , i32ElePerBlock , MPI_INT , i32Next , 0 ,MPI_COMM_WORLD, &Request[5] );	
